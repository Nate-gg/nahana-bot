...
/**
 * Responds with Embed Message Template
 * @param {String} error - Message to dispaly
 * @param {String} img - Icon to show
 * @param {String} color - color to use
 * @returns - Embed Message
 */

exports.RSP = (error, img, color = '#efb055') => {
	const msg = new MessageEmbed().setColor(color).setAuthor(error, img)
	return msg
}

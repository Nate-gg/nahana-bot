...
module.exports = {
    ...
    execute(message, args) {
        if (!message.mentions.users.size) {
            return message.channel.send(rsp('You need to tag a user to umute them.', errorImg))
        }
        ...
        return message.channel.send(rsp(`OK ... You can talk now ${member.displayName}`, avatar))
    },
}